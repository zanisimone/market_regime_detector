...
def run_kmeans_rolling(
    ...
    """
    Run a rolling backtest by refitting KMeans on each expanding window slice.
    ...
    oos_days : int, default 21
        Out-of-sample prediction horizon in business days per iteration.
    step_days : int, default 21
        Step size in business days between refits.
    k : int, default 3
        Number of clusters.
