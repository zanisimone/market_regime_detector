...
def main() -> None:
    """
    CLI entry point for Gaussian Mixture rolling backtest with reporting.
    """
    from src.config import FEATURES_PARQUET, PROC_DIR, PANEL_PARQUET, REPORTS_DIR
    from src.models.gmm_rolling import run_gmm_rolling
    ...
    ap.add_argument("--out-dir", type=str, default=str(PROC_DIR / "gmm_rolling"))
    ap.add_argument("--reports-dir", type=str, default=str(REPORTS_DIR / "gmm_rolling"))
    ...
    labels_path, schedule_path = run_gmm_rolling(
